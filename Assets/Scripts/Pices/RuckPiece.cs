...
public class RuckPiece : IPieces
{
    public RuckPiece(bool isWhite)
    {
        IsWhite = isWhite;
    }
    public bool IsWhite { get; set; }

    public PieceTypes Type => PieceTypes.Ruck;
    ...
    public async UniTask<BoardState[]> GetValidMoves(BoardState state)
    {
        ...
        {
            RuckMove(state, position, 0, 1),
            RuckMove(state, position, 0, -1),
            RuckMove(state, position, 1, 0),
            RuckMove(state, position, -1, 0),
        };
    ...
    private async UniTask<BoardState[]> RuckMove(BoardState state, Vector2Int position, int x, int y)
    {
