...
public class BishopPiece : IPieces
{
    public BishopPiece(bool isWhite)
    {
        IsWhite = isWhite;
    }
    public bool IsWhite { get; set; }
    public PieceTypes Type => PieceTypes.Bishop;
    ...
    private async UniTask<BoardState[]> BishopMove(BoardState state, Vector2Int position, int x, int y)
    {
